...
| Kenney Skyboxes | 5 panoramic (equirectangular, 4096×2048) sky textures — day/morning/night/alien/space. The **day** one is wired as the scene skybox (Stage 3i, see [completed.md](completed.md)); the other 4 are for the eventual time-of-day system (`art-info.md`'s Lighting section) and aren't used yet | `Assets/Art/Environment/Kenney-Skyboxes/` | [kenney.nl/assets/skyboxes](https://kenney.nl/assets/skyboxes) | CC0 |
