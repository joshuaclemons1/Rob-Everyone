...
- **Homeowner character** — model + the 3 alert-state reads (Idle → Suspicious → Alerted). Even a simple rig with 3 poses/animations communicates state without needing full animation work yet.
